...
const ProTourFeatures = [
  {
    link: 'https://community.firemail.wang/t/add-reminders-to-sent-messages/157',
  ...
  {
    link: 'https://community.firemail.wang/t/view-contact-and-company-profiles/159',
  ...
  {
    link:
      'https://community.firemail.wang/t/read-receipts-link-tracking-and-activity-reports/162',
  ...
  {
    link: 'https://community.firemail.wang/t/reply-faster-with-email-templates/167',
  ...
  {
    link: 'https://community.firemail.wang/t/schedule-messages-to-send-later/158',
  ...
  {
    link: 'https://community.firemail.wang/t/snooze-emails-to-handle-them-later/161',
  ...
  {
    link: 'https://community.firemail.wang/t/automatically-translate-incoming-email/166',
      ...
      <div className="row padded">
        <div>
          {localizedReactFragment(
            ...
            <a href="https://community.firemail.wang/docs?topic=241">
